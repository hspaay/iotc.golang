...
type PublisherIdentity struct {
	...
	Domain           string `json:"domain"`                // IoT domain name
...
type PublisherIdentityMessage struct {
	...
	Signature string            `json:"signature"` // base64 encoded signature of this identity
	Signer    string            `json:"signer"`    // name of the signer of this identity, eg 'DSS' or 'Lets Encrypt'
